...
import { getDailyClose, getIEXData } from './actions/index';
...
class DailyPage extends Component {
    ...
    render() {
        ...
        var dayPriceObj = dayTicker["Time Series (Daily)"]              //separates closing prices from dayTicker assigns it to dayPriceObj
        if (dayPriceObj) {
        ...
        var dayPriceObj = dayTicker["Time Series (Daily)"]              //separates closing pices form dayTicker and assigns it to dayPriceObj
        if (dayPriceObj) {
        ...
        return (
            ...
            <div className="page-container">
                <Navbar />
                <h2 className="page-header">Short Term Snapshot</h2>
...
export default connect(mapStateToProps, mapPropsToDispatch)(DailyPage);
